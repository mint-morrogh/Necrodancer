...
const DIFFICULTY_SETTINGS = {
  easy: {
    ...
    chestChance: 12, sideQuestChance: 5, alchemistChance: 3,
    startingRerolls: 2,
  ...
  normal: {
    ...
    chestChance: 8, sideQuestChance: 5, alchemistChance: 3,
    startingRerolls: 1,
  ...
  hard: {
    ...
    chestChance: 5, sideQuestChance: 7, alchemistChance: 4,
    startingRerolls: 1,
  ...
  nightmare: {
    ...
    chestChance: 3, sideQuestChance: 10, alchemistChance: 5,
    startingRerolls: 0,
